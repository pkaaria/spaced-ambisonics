...
├── README.md           this file
└── stl/
    ├── star/           radial array, stand-mounted from the central hub
    ├── pyramid/        open tetrahedron, stand-mounted via the Mic 3 piece
    └── grippers/
...
### Star (radial, outside-array only)
...
A central 3D printed hub piece sits on top of the stand. Four M6 threaded rods thread into the hub and radiate outward in a star pattern following the right-hand-rule tetrahedral geometry. Each rod terminates in a gripper that holds a capsule.
...
- **Robustness:** the load is distributed across four rods meeting at a solid hub. Sturdier than the Pyramid design and the more forgiving choice for travel or field work.
...
### Pyramid (open tetrahedron, inside or outside)
...
<table align="center">
  <tr>
    ...
    <td align="center">
      <img src="../images/EMI2.png" alt="photo of the EMI inverse array" width="100%"><br>
...
- **Robustness:** the tetrahedron is held together at the vertices by relatively thin aluminium rods, so this design is more fragile than the Star and needs more care in handling.
...
- The Pyramid design especially relies on thin connecting rods and should be handled gently.
...
- Windshield designs for the Star and Pyramid arrays.
- STLs for 8 capsule and 16 capsule spaced arrays (second and third order).
- v2 redesigns of the Star and Pyramid with easier spacing adjustment.
