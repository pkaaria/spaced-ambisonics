...
<table align="center">
  <tr>
    <td align="center">
      <img src="images/pyramid.png" alt="photo of the Pyramid array" width="100%"><br>
      <em>"Inverse" Ambisonics</em>
    </td>
    <td align="center">
      <img src="images/star.png" alt="photo of the Star array" width="100%"><br>
      <em>"Normal" Ambisonics</em>
    </td>
  </tr>
  <tr>
    <td align="center">
      <img src="images/EMI.png" alt="photo of the EMI array" width="100%"><br>
      <em>Electromagnetic Ambisonics</em>
    </td>
    <td align="center">
      <img src="images/Plugin.png" alt="screenshot of the plugin" width="100%"><br>
...
The tradeoff is at high frequencies. Spatial aliasing scales with capsule distance, so a wider array has a lower spatial Nyquist than a tight one, and in theory this should degrade directional resolution in the top octaves. In practice the interaural time and level differences encoded in the spaced signal appear to do useful perceptual work alongside the directional reconstruction. For acoustic recording at 28cm spacing the spatial aliasing frequency is around 610Hz, meaning higher order components above that frequency are aliased rather than resolving additional spatial detail — the perceptual difference between orders is smaller than the energy visualiser suggests. For electromagnetic recording the picture is different: EM field wavelengths don't alias at any practical capsule spacing, and the difference between orders is clearly audible. What the right order recommendation is for acoustic mics at different spacings is an active area of investigation. Formal localisation tests against established encoders are on the to-do list.
...
An open tetrahedral frame. One capsule points straight down so the array can mount on a standard mic stand through the bottom capsule’s holder. The frame builds upward from that point. Because the interior is hollow it can be used both for recording the surrounding space and for recording a source placed inside the array.

![photo of the Pyramid array](images/pyramid.png)
...
### Star (radial, stand-mounted from hub)

A central hub piece sits on top of the stand and four threaded rods radiate outward from it in a star pattern. Use when you want a symmetric distribution and outside-array recording only.

![photo of the Star array](images/star.png)
...
- A central piece that holds threaded rods acting as the structural spine (Star), or corner pieces attached using aluminium rods leaving an empty central area (Pyramid).
...
- **Hardware**
  - v2 redesigns of the Star and Pyramid arrays with better durability and assembly.
  - Windshields for both array variants (currently absent from v1).
